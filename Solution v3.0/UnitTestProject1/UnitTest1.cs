...
using BorwellSofwareChallenge_v3._0;
using System;
...
namespace UnitTestProject1
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void Test_12_CoordInputTwoEntries()
        {
            bool expectedFail = false;
            bool expectedPass = true;
            bool testFail = (Program.CheckCoordInput("1 2 3")).ValidInput;
            bool testFail2 = (Program.CheckCoordInput("1")).ValidInput;
            bool testPass = (Program.CheckCoordInput("1 2")).ValidInput;
            Assert.AreEqual(expectedFail, testFail);
            Assert.AreEqual(expectedFail, testFail2);
            Assert.AreEqual(expectedPass, testPass);
        }
        ...
        [TestMethod]
        public void Test_13_CoordInputNumericEntries()
        {
            bool expectedFail = false;
            bool expectedPass = true;
            bool testFail = (Program.CheckCoordInput("one two")).ValidInput;
            bool testPass = (Program.CheckCoordInput("1 2")).ValidInput;
            Assert.AreEqual(expectedFail, testFail);
            Assert.AreEqual(expectedPass, testPass);
        }
        ...
        [TestMethod]
        public void Test_14_CoordInputRange()
        {
            bool expectedFail = false;
            bool expectedPass = true;
            bool testFail1 = Program.CheckCoordInput($"{double.MaxValue.ToString("e")} {double.MaxValue.ToString("e")}").ValidInput;
            bool testFail2 = Program.CheckCoordInput($"{(-double.MaxValue).ToString("e")} {(-double.MaxValue).ToString("e")}").ValidInput;
            bool testPass1 = Program.CheckCoordInput($"{Math.Pow(double.MaxValue, 1.0/2.1).ToString("e")} {Math.Pow(double.MaxValue, 1.0 / 2.1).ToString("e")}").ValidInput;
            bool testPass2 = Program.CheckCoordInput($"{(-Math.Pow(double.MaxValue, 1.0 / 2.1)).ToString("e")} {(-Math.Pow(double.MaxValue, 1.0 / 2.1)).ToString("e")}").ValidInput;
